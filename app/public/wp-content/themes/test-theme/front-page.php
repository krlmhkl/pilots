...
<article class="content px-3 py-5 p-md-5">
    ...
    <div class="blue-block">
        <h2 class="light-title">Eesti Erapilootide Liit</h2>
        <div class="text-block"><span class="description-text">Eesti Erapilootide Liit (EEL) asutati 8. jaanuaril 2003 tookord 32 harrastuspiloodi poolt eesmärgiga koondada Eesti Vabariigis eralennundusega tegelevaid ning eralennundusest huvitatud isikuid.
